...
def Config():
    ...
    conf.ilbls = ["Animal","Trailer","EmergencyVehicle"]
    conf.lbls = ['Car', 'Pedestrian',"Truck","VanSUV",'Cyclist',"Bus","MotorBiker","Bicycle","UtilityVehicle","Motorcycle","CaravanTransporter"]
